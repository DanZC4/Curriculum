              ...
              <div class="text-xl px-4 pb-8">
                <div class="mt-10 mb-12">
                  <div class="flex flex-wrap justify-between  gap-12">
                    <div v-for="page in pages" :key="page.id" v-on:mouseover="ligths = page.id"
                      v-on:mouseleave="ligths = null" class="
                      w-72
                      ant:w-80
                      h-auto
                      text-center
                        ...
                        <a :href="page.link">
                          <div class="space-y-2 pt-2">
                            <div class="flex justify-between items-center">
                              <img src="~/static/img/paper-lantern.svg" class="rounded-full  duration-200"
                                :class="ligths == page.id ? 'bg-opacity-40 bg-yellow-300 shadow-yellow-300 shadow' : ''"
...
.arenadeabajo{
  clip-path: polygon(0 32%, 0 0, 100% 0, 100% 33%, 89% 81%, 79% 83%, 68% 84%, 54% 88%, 45% 90%, 33% 90%, 25% 88%, 18% 88%, 11% 80%);
}
