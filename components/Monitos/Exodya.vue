                ...
                <div class="levitato">
                    <div class="flex flex-col items-center ">
                        ...
                        <div class="translate-y-5 z-20">
                            ...
                            <div class="w-0 h-0 border-t-[2rem] border-t-transparent border-x-[4rem] border-x-transparent border-b-[2rem] "
                                :class="darkmode ? 'border-b-gray-800' : 'border-b-gray-700'">
                            </div>
                            <div class="w-full h-1.5  -translate-y-0.5 rounded-xl"
                                :class="darkmode ? 'bg-black' : 'bg-gray-900'"></div>
                        </div>
                        <!-- face -->
                        <div class="w-12 h-14 rounded-full  flex items-center border-b-2  border-gray-800 z-10"
                            :class="darkmode ? 'bg-gray-600 border-gray-800' : 'bg-gray-400 border-gray-800'"
                            @click="toBlink">
                            <div class="w-[3.25rem] h-2  -mt-1 absolute rounded-sm -ml-0.5 z-20 "
                                :class="darkmode ? 'bg-gray-900' : 'bg-gray-800'">
                                <!-- bandas detras de la cabesa -->
                                <div
                                    class="translate-x-[3rem] absolute rotate-[25deg] translate-y-4 translate-x-[2.8rem]">
                                    <div class="w-12 h-2  skew-x-[25deg] "
                                        :class="darkmode ? 'bg-gray-900' : 'bg-gray-800'"></div>
                                    <div class="w-12 h-2  skew-x-[25deg] rotate-12"
                                        :class="darkmode ? 'bg-gray-900' : 'bg-gray-800'"></div>
                                </div>
                                <!-- Glases -->
                                <div class="flex space-x-1 -mt-0.5 ml-1">
                                    <div class="w-5 h-3.5  border-2  rounded-tl rounded-br rounded-tr-lg rounded-bl-lg "
                                        :class="darkmode ? blink ? 'bg-gray-900 border-gray-900' : 'bg-gray-50 border-black' : blink ? 'bg-gray-800 border-gray-800' : 'bg-gray-50 border-gray-900'">
                                    </div>
                            ...
                            <!-- barbilla -->
                            <div
                                class="w-3 h-1.5 rounded-t-xl transform translate-y-[1.55rem] translate-x-[1.15rem]  absolute"  :class="darkmode ? 'bg-gray-900' : 'bg-gray-800'">
                                <div
                                    class="absolute w-[1.40rem] h-1  translate-x-[0.55rem] -translate-y-[0.20rem] transform rotate-[150deg] "  :class="darkmode ? 'bg-gray-900' : 'bg-gray-800'">
                                    <div
                                        class="absolute w-1 h-[1.40rem]  rotate-[30deg] -translate-x-[0.40rem]"  :class="darkmode ? 'bg-gray-900' : 'bg-gray-800'">
                                    </div>
                                </div>

                                <div
                                    class="absolute w-[1.40rem] h-1  -translate-x-[1.25rem] -translate-y-[0.20rem] transform -rotate-[150deg]"  :class="darkmode ? 'bg-gray-900' : 'bg-gray-800'">
                                    <div
                                        class="absolute w-1 h-[1.40rem] -rotate-[30deg] translate-x-[1.55rem]"  :class="darkmode ? 'bg-gray-900' : 'bg-gray-800'">
                                    </div>
                                </div>
                            </div>
                            <div class="w-5 h-full border-x border-dashed  translate-x-3.5 z-10"  :class="darkmode ? 'border-gray-900' : 'border-gray-800'"></div>
                        </div>
                    ...
                    <div class="absolute flex  h-[3rem] flag">
                        <div class="w-[5rem] h-full bg-green-800 " :class="darkmode ? 'bg-green-900' : 'bg-green-800'">
                        </div>
                    ...
                    <!-- neck -->
                    <div class="flex flex-col items-center ">
                        <div class="w-8 h-1  -translate-y-2 z-0" :class="darkmode ? 'bg-gray-600' : 'bg-gray-500'"></div>
                        ...
                        <div>
                            ...
                            <div>
                                <div
                                    ...
                                    <div class="w-[0.4rem] h-[0.4rem] bg-gray-500 rounded-full border border-gray-900">
                                    </div>
                                </div>
                                <div
                            ...
                            <div class="bg-gray-500 h-[2.1rem] w-[4rem]  translate-x-[0.68rem] flex">
                                <!--pierna -->
                                <div
                                    class="bg-gray-500 h-[2.2rem] w-[4rem] -translate-y-[0.45rem] -translate-x-[3.8rem] rounded-l-full skew-y-[8deg] rotate-[5deg]">
                                    <div
                                        class="bg-gray-400 h-[2rem] w-[6rem] translate-y-[0.58rem] translate-x-[0rem] rounded-l-full  rotate-[12deg] border-r-4 border-gray-800 flex justify-end">
                                ...
                                <div class="rotate-Y-pierna">
                                    <div
                                        class="bg-gray-500 h-[2.2rem] w-[4rem] -translate-y-[0.45rem] translate-x-[0.5rem] rounded-l-full skew-y-[8deg] rotate-[5deg] ">
                                        <div
                                            class="bg-gray-400 h-[2rem] w-[6rem] translate-y-[0.58rem] translate-x-[0rem] rounded-l-full  rotate-[12deg] border-r-4 border-gray-800 flex justify-end">
                                            <div class="flex translate-x-[2rem] ">
                                                <!--bota -->
                                                <div
                                                    class="w-[3rem] h-[2rem] bg-gray-600 rounded-r-full flex justify-end">
                                                    <div class="w-[0.25rem] h-[2rem] bg-gray-700"></div>
                                                    <div class="flex flex-col justify-around">
                                                        <div class="w-[2rem] h-0.5 bg-gray-700 rotate-6"></div>
                                                        <div class="w-[2rem] h-0.5 bg-gray-700 -rotate-6"></div>
